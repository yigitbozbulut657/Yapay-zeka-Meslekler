document.addEventListener('DOMContentLoaded', () => {
    ...
    function showDetail(sectorId, profId) {
        ...
        let articleHTML = prof.article;
        if (!articleHTML.includes('<p>') && !articleHTML.includes('<h4>')) {
            articleHTML = articleHTML.split('\n\n').map(para => `<p>${para}</p>`).join('');
        }
        ...
        professionDetail.innerHTML = `
            <div class="detail-card">
                ...
                <div class="detail-content">
                    <div class="app-watermark"><img src="images/topluluk.png" alt="Topluluk Logo"></div>
